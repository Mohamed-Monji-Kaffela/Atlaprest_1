import 'package:exemple4/Widgets/Cards_of_pages/Cards_Realise.dart';
import 'package:exemple4/Widgets/Count_pour_statistique/all_length_state_validation.dart';
import 'package:exemple4/Widgets/Count_pour_statistique/length_state_realise_green.dart';
import 'package:exemple4/Widgets/Count_pour_statistique/length_state_rouge.dart';
import 'package:exemple4/Widgets/Count_pour_statistique/length_validation_green.dart';
import 'package:exemple4/Widgets/Count_pour_statistique/length_validation_white.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

import '../Widgets/Cards_of_pages/Cards.dart';
import '../Widgets/Count_pour_statistique/length_validation_orange.dart';
import '../Widgets/config.dart';
import '../Widgets/drawer.dart';
import '../dbHelper/mongodb.dart';
import '../dbHelper/mongodb_model.dart';

class RealisesPage extends StatefulWidget {
  const RealisesPage({super.key});

  @override
  State<RealisesPage> createState() => _RealisesPageState();
}

class _RealisesPageState extends State<RealisesPage> {
            ...
            children: [
              ...
              if (_isSearching) Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return displayCardRealise(filteredData[index]);
                  },
                ),
              ),
              ...
              if (!_isSearching) Expanded(
                child: FutureBuilder(
                  ...
                  builder: (context, AsyncSnapshot snapshot) {     // snapshot 3al retoure de getData()
